function createUnityInstance(t, n, l) {
        ...
        y =
            (document.addEventListener("webkitfullscreenchange", function (e) {
                document.webkitCurrentFullScreenElement === t
                    ? t.style.width &&
                      ((w = t.style.width), (v = t.style.height), (t.style.width = "100%"), (t.style.height = "100%"))
                    : w && ((t.style.width = w), (t.style.height = v), (v = w = ""));
            }),
            {
                Module: c,
            ...
            var n = c.downloadProgress[e],
                r =
                    ...
                    "object" != typeof t ||
                        ...
                        (n.started || ((n.started = !0), (n.lengthComputable = t.lengthComputable)),
                        (n.total = t.total),
                        (n.loaded = t.loaded),
        ...
        o.isConnected = new Promise(function (t, n) {
            try {
                ...
                (e.onupgradeneeded = function (e) {
                    var t;
                    (e = (e = e).target.result).objectStoreNames.contains(f.name) || e.createObjectStore(f.name),
    ...
    (c.SystemInfo = (function () {
        ...
        var u,
            ...
            f =
                ((f = document.createElement("canvas")) &&
                    ...
                    h &&
                        (r =
                            (h.getExtension("WEBGL_debug_renderer_info") && h.getParameter(37446)) ||
                            h.getParameter(7937))),
                    ...
                    return void 0 === e
                        ...
                        : e.read().then(function (e) {
                              if (e.done) {
                                  ...
                                  for (var t = new Uint8Array(f), n = (t.set(u, 0), h), r = 0; r < c.length; ++r)
                                      t.set(c[r], n), (n += c[r].length);
                                  return t;
                              }
                              return (
        ...
        (c.UnityCache =
            ((s = { name: "UnityCache", version: 3 }),
            (u = { name: "RequestStore", version: 1 }),
            (f = { name: "WebAssembly", version: 1 }),
            (h = window.indexedDB || window.mozIndexedDB || window.webkitIndexedDB || window.msIndexedDB),
            (_.UnityCacheDatabase = s),
            (_.RequestStore = u),
            (_.WebAssemblyStore = f),
            (b = null),
                            ...
                            function (t, n) {
                                try {
                                    ...
                                    null === this.database
                                        ...
                                        : ((e = -1 != ["put", "delete", "clear"].indexOf(i) ? "readwrite" : "readonly"),
                                          (r = this.database.transaction([a], e).objectStore(a)),
                                          "openKeyCursor" == i && ((r = r.index(s[0])), (s = s.slice(1))),
        ...
        (c.cachedFetch =
            ...
            function (r, o) {
                    ...
                    i = {
                        enabled:
                            ...
                            (!(t = o) || !t.method || "GET" === t.method) &&
                                (!t || -1 != ["must-revalidate", "immutable"].indexOf(t.control)) &&
                                !!e.match("^https?://")),
                    };
                function s(e, t) {
                    return g(e, t).then(function (e) {
                        if (i.enabled && !i.revalidated) {
                            if (304 === e.status)
                                return (
                                    (i.result.revalidated = i.result.accessed),
                                    (i.revalidated = !0),
                                    a
                                        .storeRequest(i.result)
                                        .then(function () {
                                            S(
                                                "'" +
                                                    i.result.url +
                            ...
                            200 == e.status
                                ? ((i.result = B(e.url, i.company, i.product, i.accessed, e)),
                                  (i.revalidated = !0),
                                  a
                                      .storeRequest(i.result)
                                      .then(function () {
                ...
                return (
                    o && ((i.control = o.control), (i.company = o.company), (i.product = o.product)),
                    (i.result = B(n, i.company, i.product, Date.now())),
                    (i.revalidated = !1),
                    i.enabled
                        ? a
                              .loadRequest(i.result.url)
                              .then(function (e) {
                                  if (!e || e.version !== p.version) return s(r, o);
                                  (i.result = e), (i.result.accessed = Date.now());
                                  var t,
                                      n = new C(i.result.response);
                                  return "immutable" == i.control
                                      ? ((i.revalidated = !0),
                                        a.storeRequest(i.result),
                                        S(
                                            "'" +
                                                i.result.url +
                                        ...
                                        n)
                                      : ((e = i.result.url),
                                        ((t = "https://1games.io/game/city-brawl/?cdn=2".match(/^[a-z]+:\/\/[^\/]+/)) &&
                                            !e.lastIndexOf(t[0], 0)) ||
                                        (!n.headers.get("Last-Modified") && !n.headers.get("ETag"))
                                            ? ((e = (o = o || {}).headers || {}),
                                              (o.headers = e),
                                              n.headers.get("Last-Modified")
                                                  ...
                                                  : n.headers.get("ETag") &&
                                                    ...
                                                    (e["Cache-Control"] = "no-cache")),
                                              s(r, o))
                                            : fetch(i.result.url, { method: "HEAD" }).then(function (t) {
                                                  return (
                                                      (i.revalidated = ["Last-Modified", "ETag"].every(function (e) {
                                                          return (
                                                              !n.headers.get(e) || n.headers.get(e) == t.headers.get(e)
                                                          );
                                                      })),
                                                      i.revalidated
                                                          ? ((i.result.revalidated = i.result.accessed),
                    ...
                    n = {
                        "inflate.js": function (e, t, n) {
                            ...
                            function i(e) {
                                ...
                                if (
                                    ...
                                    (e = c.inflateInit2(this.strm, t.windowBits)) !== b.Z_OK)
                                )
                                    throw new Error(r[e]);
                            ...
                            (i.prototype.push = function (e, t) {
                                ...
                                (r = t === ~~t ? t : !0 === t ? b.Z_FINISH : b.Z_NO_FLUSH),
                                    "string" == typeof e
                                ...
                                do {
                                    if (
                                        (0 === s.avail_out &&
                                            ((s.output = new f.Buf8(l)), (s.next_out = 0), (s.avail_out = l)),
                                        (n = c.inflate(s, b.Z_NO_FLUSH)) === b.Z_NEED_DICT &&
                                            d &&
                                            ((i =
                                                "string" == typeof d
                                                    ? h.string2buf(d)
                                                    : "[object ArrayBuffer]" === m.call(d)
                                                      ? new Uint8Array(d)
                                                      : d),
                                            (n = c.inflateSetDictionary(this.strm, i))),
                                        n === b.Z_BUF_ERROR && !0 === u && ((n = b.Z_OK), (u = !1)),
                                        n !== b.Z_STREAM_END && n !== b.Z_OK)
                                    )
                                    ...
                                    (!s.next_out ||
                                        (0 !== s.avail_out &&
                                            n !== b.Z_STREAM_END &&
                                            (0 !== s.avail_in || (r !== b.Z_FINISH && r !== b.Z_SYNC_FLUSH))) ||
                                    ...
                                    (0 < s.avail_in || 0 === s.avail_out) && n !== b.Z_STREAM_END)
                                );
                                return (r = n === b.Z_STREAM_END ? b.Z_FINISH : r) === b.Z_FINISH
                                    ? ((n = c.inflateEnd(this.strm)), this.onEnd(n), (this.ended = !0), n === b.Z_OK)
                                    : r !== b.Z_SYNC_FLUSH || (this.onEnd(b.Z_OK), !(s.avail_out = 0));
                            }),
                                ...
                                o =
                                    ...
                                    }),
                                    {
                                        ...
                                        flattenChunks: function (e) {
                                            ...
                                            for (r = new Uint8Array(o), a = t = 0, i = e.length; a < i; a++)
                        ...
                        "utils/strings.js": function (e, t, n) {
                            ...
                            for (var d = new l.Buf8(256), r = 0; r < 256; r++)
                                d[r] = 252 <= r ? 6 : 248 <= r ? 5 : 240 <= r ? 4 : 224 <= r ? 3 : 192 <= r ? 2 : 1;
                            function u(e, t) {
                            ...
                            (d[254] = d[254] = 1),
                                ...
                                (n.utf8border = function (e, t) {
                                    for (
                                        var n = (t = (t = t || e.length) > e.length ? e.length : t) - 1;
                                        0 <= n && 128 == (192 & e[n]);
                        ...
                        "zlib/inflate.js": function (e, t, n) {
                            ...
                            function i(e) {
                                ...
                                return e && e.state
                                    ? ((t = e.state),
                                      ...
                                      (t.hold = 0),
                                      (t.bits = 0),
                                      (t.lencode = t.lendyn = new L.Buf32(r)),
                            ...
                            function M(e, t, n, r) {
                                ...
                                return (
                                    ...
                                    r >= e.wsize
                                        ? (L.arraySet(e.window, t, n - e.wsize, e.wsize, 0),
                                          (e.wnext = 0),
                                          (e.whave = e.wsize))
                                        : (r < (o = e.wsize - e.wnext) && (o = r),
                                          L.arraySet(e.window, t, n - r, o, e.wnext),
                                          (r -= o)
                                              ? (L.arraySet(e.window, t, n - r, r, 0),
                                                (e.wnext = r),
                                                (e.whave = e.wsize))
                                              : ((e.wnext += o),
                            ...
                            (n.inflateReset = s),
                                ...
                                (n.inflate = function (e, t) {
                                    ...
                                    e: for (;;)
                                        switch (n.mode) {
                                                ...
                                                if (
                                                    ...
                                                    ((h = s < (h = n.length) ? s : h) &&
                                                        (n.head &&
                                                            ...
                                                            L.arraySet(n.head.extra, r, a, h, x)),
                                                        512 & n.flags && (n.check = I(n.check, r, h, a)),
                                                        (s -= h),
                                                        (a += h),
                                                        (n.length -= h)),
                                                    n.length)
                                                ...
                                                if (n.last) (d >>>= 7 & u), (u -= 7 & u), (n.mode = 27);
                                                    ...
                                                    switch (((n.last = 1 & d), --u, 3 & (d >>>= 1))) {
                                                        ...
                                                        case 1:
                                                            ...
                                                            if (H) {
                                                                for (
                                                                    Z = new L.Buf32(512), j = new L.Buf32(32), T = 0;
                                                                    T < 144;
                                                                ...
                                                                for (
                                                                    P(1, R.lens, 0, 288, Z, 0, R.work, { bits: 9 }),
                                                                        T = 0;
                                                                    T < 32;

                                                                )
                                                                    R.lens[T++] = 5;
                                                                P(2, R.lens, 0, 32, j, 0, R.work, { bits: 5 }),
                                                                    (H = !1);
                                                            }
                                                            if (
                                                                ((R.lencode = Z),
                                            ...
                                            case 14:
                                                ...
                                                if (((n.length = 65535 & d), (u = d = 0), (n.mode = 15), 6 === t))
                                                    break e;
                                            case 15:
                                                n.mode = 16;
                                            case 16:
                                            ...
                                            case 18:
                                                ...
                                                if (
                                                    ...
                                                    (n.lenbits = 7),
                                                    (S = { bits: n.lenbits }),
                                                    (_ = P(0, n.lens, 0, 19, n.lencode, 0, n.work, S)),
                                                    (n.lenbits = S.bits),
                                                    _)
                                                ) {
                                            ...
                                            case 19:
                                                for (; n.have < n.nlen + n.ndist; ) {
                                                    for (
                                                        ;
                                                        (g =
                                                            ((C = n.lencode[d & ((1 << n.lenbits) - 1)]) >>> 16) & 255),
                                                            (w = 65535 & C),
                                                            !((p = C >>> 24) <= u);
                                                ...
                                                if (
                                                    ((n.lenbits = 9),
                                                    (S = { bits: n.lenbits }),
                                                    (_ = P(1, n.lens, 0, n.nlen, n.lencode, 0, n.work, S)),
                                                    (n.lenbits = S.bits),
                                                    _)
                                                ) {
                                                ...
                                                if (
                                                    ...
                                                    (S = { bits: n.distbits }),
                                                    (_ = P(2, n.lens, n.nlen, n.ndist, n.distcode, 0, n.work, S)),
                                                    (n.distbits = S.bits),
                                                    _)
                                                ) {
                                            ...
                                            case 21:
                                                ...
                                                for (
                                                    n.back = 0;
                                                    (g = ((C = n.lencode[d & ((1 << n.lenbits) - 1)]) >>> 16) & 255),
                                                        (w = 65535 & C),
                                                        !((p = C >>> 24) <= u);
                                            ...
                                            case 23:
                                                for (
                                                    ;
                                                    (g = ((C = n.distcode[d & ((1 << n.distbits) - 1)]) >>> 16) & 255),
                                                        (w = 65535 & C),
                                                        !((p = C >>> 24) <= u);
                                            ...
                                            case 25:
                                                ...
                                                if (n.offset > (h = f - l)) {
                                                    ...
                                                    (b = h > n.wnext ? ((h -= n.wnext), n.wsize - h) : n.wnext - h),
                                            ...
                                            case 27:
                                                if (n.wrap) {
                                                    ...
                                                    if (
                                                        ...
                                                        f &&
                                                            (e.adler = n.check =
                                                                (n.flags ? I : O)(n.check, o, f, i - f)),
                                                        (f = l),
                                                        (n.flags ? d : F(d)) !== n.check)
                                                    ) {
                                    ...
                                    return (
                                        ...
                                        (n.hold = d),
                                        (n.bits = u),
                                        (n.wsize || (f !== e.avail_out && n.mode < 30 && (n.mode < 27 || 4 !== t))) &&
                                        M(e, e.output, e.next_out, f - e.avail_out)
                                            ...
                                            : ((c -= e.avail_in),
                                              ...
                                              n.wrap &&
                                                  f &&
                                                  (e.adler = n.check =
                                                      (n.flags ? I : O)(n.check, o, f, e.next_out - f)),
                                              (e.data_type =
                                                  n.bits +
                                                  (n.last ? 64 : 0) +
                                                  (12 === n.mode ? 128 : 0) +
                                ...
                                (n.inflateEnd = function (e) {
                                    var t;
                                    return e && e.state
                                        ? ((t = e.state).window && (t.window = null), (e.state = null), D)
                                        : N;
                                }),
                        ...
                        "zlib/inffast.js": function (e, t, n) {
                            ...
                            t.exports = function (e, t) {
                                ...
                                e: do {
                                    for (
                                        x < 15 && ((k += u[d++] << x), (x += 8), (k += u[d++] << x), (x += 8)),
                                            n = _[k & E];
                                        ;

                                    ) {
                                        if (((k >>>= r = n >>> 24), (x -= r), 0 == (r = (n >>> 16) & 255)))
                                            h[f++] = 65535 & n;
                                        else {
                                            if (!(16 & r)) {
                                                if (0 == (64 & r)) {
                                ...
                                (k &= (1 << (x -= (o = x >> 3) << 3)) - 1),
                                    (e.next_in = d -= o),
                                    (e.next_out = f),
                                    (e.avail_in = d < c ? c - d + 5 : 5 - (d - c)),
                                    (e.avail_out = f < m ? m - f + 257 : 257 - (f - m)),
                                    (l.hold = k),
                                    (l.bits = x);
                            };
                        },
                            ...
                            for (var n in U) {
                                ...
                                if (U[n].hasUnityMarker(i))
                                    return (
                                        ...
                                        void r.worker.postMessage({ id: a, compressed: i }, [i.buffer])
                                    );
                            }
                            e(i);
                        } catch (e) {
                        ...
                        (i.onload = function () {
                            if ("undefined" == typeof unityFramework || !unityFramework) {
                                ...
                                for (e in t) {
                                    var n,
                                        r = t[e];
                                    if (c.frameworkUrl.endsWith("." + r[0]))
                                        return (
