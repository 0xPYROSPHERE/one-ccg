function createUnityInstance(t, r, l) {
    ...
    function e(e, t, r) {
        var n = e[t];
        void 0 !== n && n || (console.warn('Config option "' + t + '" is missing or empty. Falling back to default value: "' + r + '". Consider updating your WebGL template to include the missing config option.'),
        e[t] = r)
    }
    l = l || function() {}
    ;
    var o, b = {
        ...
        streamingAssetsUrl: "https://cdn.jsdelivr.net/gh/0xPYROSPHERE/one-ccg@main/holeio/b/4/StreamingAssets",
        downloadProgress: {},
        deinitializers: [],
        intervals: {},
    ...
    function p(e, t) {
        if ("symbolsUrl" != e) {
            ...
            for (e in b.downloadProgress) {
                if (!(r = b.downloadProgress[e]).started)
                    return;
                i++,
                r.lengthComputable ? (n += r.loaded,
                o += r.total,
                a++) : r.finished || s++
            }
    ...
    b.SystemInfo = function() {
        var e, t, r, n, o, i = navigator.userAgent + " ", a = [["Firefox", "Firefox"], ["OPR", "Opera"], ["Edg", "Edge"], ["SamsungBrowser", "Samsung Browser"], ["Trident", "Internet Explorer"], ["MSIE", "Internet Explorer"], ["Chrome", "Chrome"], ["CriOS", "Chrome on iOS Safari"], ["FxiOS", "Firefox on iOS Safari"], ["Safari", "Safari"]];
        function s(e, t, r) {
        ...
        for (var d = [["Windows (.*?)[;)]", "Windows"], ["Android ([0-9_.]+)", "Android"], ["iPhone OS ([0-9_.]+)", "iPhoneOS"], ["iPad.*? OS ([0-9_.]+)", "iPadOS"], ["FreeBSD( )", "FreeBSD"], ["OpenBSD( )", "OpenBSD"], ["Linux|X11()", "Linux"], ["Mac OS X ([0-9_\\.]+)", "MacOS"], ["bot|google|baidu|bing|msn|teoma|slurp|yandex", "Search Bot"]], f = 0; f < d.length; ++f)
            if (n = s(d[f][0], i, 1)) {
                r = d[f][1],
                n = n.replace(/_/g, ".");
                break
    ...
    b.readBodyWithProgress = function(i, a, s) {
        ...
        function o() {
            return void 0 === e ? i.arrayBuffer().then(function(e) {
                ...
                if (e.done) {
                    ...
                    if (c < d)
                        return f.slice(0, c);
                    for (var t = new Uint8Array(c), r = (t.set(f, 0),
                    h), n = 0; n < u.length; ++n)
                        t.set(u[n], r),
                        r += u[n].length;
                    return t
                }
                return c + e.value.length <= f.length ? (f.set(e.value, c),
                h = c + e.value.length) : u.push(e.value),
                c += e.value.length,
                a({
                    type: "progress",
                    response: i,
    ...
    var w = {
            ...
            require: function(e) {
                var t, r = {
                    "inflate.js": function(e, t, r) {
                        ...
                        function s(e, t) {
                            if ((t = new a(t)).push(e, !0),
                            t.err)
                                throw t.msg || n[t.err];
                            return t.result
                        }
                        a.prototype.push = function(e, t) {
                            var r, n, o, i, a, s = this.strm, l = this.options.chunkSize, d = this.options.dictionary, f = !1;
                            if (this.ended)
                                return !1;
                            ...
                            do {
                                if (0 === s.avail_out && (s.output = new c.Buf8(l),
                                s.next_out = 0,
                                s.avail_out = l),
                                (r = u.inflate(s, m.Z_NO_FLUSH)) === m.Z_NEED_DICT && d && (a = "string" == typeof d ? h.string2buf(d) : "[object ArrayBuffer]" === b.call(d) ? new Uint8Array(d) : d,
                                ...
                                r !== m.Z_STREAM_END && r !== m.Z_OK)
                                    return this.onEnd(r),
                                    !(this.ended = !0)
                            } while (!s.next_out || 0 !== s.avail_out && r !== m.Z_STREAM_END && (0 !== s.avail_in || n !== m.Z_FINISH && n !== m.Z_SYNC_FLUSH) || ("string" === this.options.to ? (a = h.utf8border(s.output, s.next_out),
                            o = s.next_out - a,
                            i = h.buf2string(s.output, a),
                            s.next_out = o,
                            s.avail_out = l - o,
                            o && c.arraySet(s.output, s.output, a, o, 0),
                            this.onData(i)) : this.onData(c.shrinkBuf(s.output, s.next_out))),
                            0 === s.avail_in && 0 === s.avail_out && (f = !0),
                            (0 < s.avail_in || 0 === s.avail_out) && r !== m.Z_STREAM_END);
                            return (n = r === m.Z_STREAM_END ? m.Z_FINISH : n) === m.Z_FINISH ? (r = u.inflateEnd(this.strm),
                            this.onEnd(r),
                            this.ended = !0,
                    ...
                    "utils/strings.js": function(e, t, r) {
                        ...
                        r.string2buf = function(e) {
                            for (var t, r, n, o, i = e.length, a = 0, s = 0; s < i; s++)
                                55296 == (64512 & (r = e.charCodeAt(s))) && s + 1 < i && 56320 == (64512 & (n = e.charCodeAt(s + 1))) && (r = 65536 + (r - 55296 << 10) + (n - 56320),
                                s++),
                        ...
                        r.buf2string = function(e, t) {
                            for (var r, n, o = t || e.length, i = new Array(2 * o), a = 0, s = 0; s < o; )
                                if ((r = e[s++]) < 128)
                                    ...
                                    for (r &= 2 === n ? 31 : 3 === n ? 15 : 7; 1 < n && s < o; )
                                        r = r << 6 | 63 & e[s++],
                                        n--;
                                    1 < n ? i[a++] = 65533 : r < 65536 ? i[a++] = r : (r -= 65536,
                                    i[a++] = 55296 | r >> 10 & 1023,
                                    i[a++] = 56320 | 1023 & r)
                                }
                            return f(i, a)
                        ...
                        r.utf8border = function(e, t) {
                            for (var r = (t = (t = t || e.length) > e.length ? e.length : t) - 1; 0 <= r && 128 == (192 & e[r]); )
                                r--;
                    ...
                    "zlib/inflate.js": function(e, t, r) {
                        ...
                        function l(e, t) {
                            ...
                            t = -t) : (r = 1 + (t >> 4),
                            t < 48 && (t &= 15)),
                            t && (t < 8 || 15 < t)) ? F : (null !== n.window && n.wbits !== t && (n.window = null),
                            n.wrap = r,
                            n.wbits = t,
                            s(e))
                        }
                        ...
                        function D(e, t, r, n) {
                            ...
                            n >= e.wsize ? (L.arraySet(e.window, t, r - e.wsize, e.wsize, 0),
                            e.wnext = 0,
                            e.whave = e.wsize) : (n < (o = e.wsize - e.wnext) && (o = n),
                            L.arraySet(e.window, t, r - n, o, e.wnext),
                            (n -= o) ? (L.arraySet(e.window, t, r - n, n, 0),
                            e.wnext = n,
                        ...
                        r.inflate = function(e, t) {
                            var r, n, o, i, a, s, l, d, f, u, c, h, m, b, g, p, w, v, y, k, _, x, S, E, U = 0, A = new L.Buf8(4), C = [16, 17, 18, 0, 8, 7, 9, 6, 10, 5, 11, 4, 12, 3, 13, 2, 14, 1, 15];
                            ...
                            e: for (; ; )
                                ...
                                case 5:
                                    ...
                                    r.mode = 6;
                                case 6:
                                    if (1024 & r.flags && ((h = s < (h = r.length) ? s : h) && (r.head && (_ = r.head.extra_len - r.length,
                                    r.head.extra || (r.head.extra = new Array(r.head.extra_len)),
                                    L.arraySet(r.head.extra, n, i, h, _)),
                                    512 & r.flags && (r.check = B(r.check, n, h, i)),
                                    s -= h,
                                    i += h,
                                    r.length -= h),
                                    r.length))
                                ...
                                case 7:
                                    if (2048 & r.flags) {
                                        if (0 === s)
                                            break e;
                                        for (h = 0; _ = n[i + h++],
                                        r.head && _ && r.length < 65536 && (r.head.name += String.fromCharCode(_)),
                                        _ && h < s; )
                                            ;
                                        if (512 & r.flags && (r.check = B(r.check, n, h, i)),
                                        s -= h,
                                        i += h,
                                        _)
                                            break e
                                ...
                                case 8:
                                    if (4096 & r.flags) {
                                        if (0 === s)
                                            break e;
                                        for (h = 0; _ = n[i + h++],
                                        r.head && _ && r.length < 65536 && (r.head.comment += String.fromCharCode(_)),
                                        _ && h < s; )
                                            ;
                                        if (512 & r.flags && (r.check = B(r.check, n, h, i)),
                                        s -= h,
                                ...
                                case 13:
                                    if (r.last)
                                        ...
                                        case 0:
                                            ...
                                            break;
                                        case 1:
                                            var T, T = P = void 0, P = r;
                                            if (M) {
                                                for (N = new L.Buf32(512),
                                                Z = new L.Buf32(32),
                                                T = 0; T < 144; )
                                                    P.lens[T++] = 8;
                                                for (; T < 256; )
                                ...
                                case 18:
                                    ...
                                    x = I(0, r.lens, 0, 19, r.lencode, 0, r.work, S),
                                    r.lenbits = S.bits,
                                    x) {
                                ...
                                case 19:
                                    for (; r.have < r.nlen + r.ndist; ) {
                                        for (; p = (U = r.lencode[d & (1 << r.lenbits) - 1]) >>> 16 & 255,
                                        w = 65535 & U,
                                        !((g = U >>> 24) <= f); ) {
                                            if (0 === s)
                                                break e;
                                    ...
                                    x = I(1, r.lens, 0, r.nlen, r.lencode, 0, r.work, S),
                                    r.lenbits = S.bits,
                                    x) {
                                    ...
                                    x = I(2, r.lens, r.nlen, r.ndist, r.distcode, 0, r.work, S),
                                    r.distbits = S.bits,
                                    x) {
                                ...
                                case 21:
                                    ...
                                    for (r.back = 0; p = (U = r.lencode[d & (1 << r.lenbits) - 1]) >>> 16 & 255,
                                    w = 65535 & U,
                                    !((g = U >>> 24) <= f); ) {
                                        if (0 === s)
                                            break e;
                                    ...
                                    if (p && 0 == (240 & p)) {
                                        for (v = g,
                                        y = p,
                                        k = w; p = (U = r.lencode[k + ((d & (1 << v + y) - 1) >> v)]) >>> 16 & 255,
                                        w = 65535 & U,
                                        !(v + (g = U >>> 24) <= f); ) {
                                            if (0 === s)
                                                break e;
                                ...
                                case 22:
                                    ...
                                    r.mode = 23;
                                case 23:
                                    for (; p = (U = r.distcode[d & (1 << r.distbits) - 1]) >>> 16 & 255,
                                    w = 65535 & U,
                                    !((g = U >>> 24) <= f); ) {
                                        if (0 === s)
                                            break e;
                                    ...
                                    if (0 == (240 & p)) {
                                        for (v = g,
                                        y = p,
                                        k = w; p = (U = r.distcode[k + ((d & (1 << v + y) - 1) >> v)]) >>> 16 & 255,
                                        w = 65535 & U,
                                        !(v + (g = U >>> 24) <= f); ) {
                                            if (0 === s)
                                                break e;
                                ...
                                case 27:
                                    if (r.wrap) {
                                        ...
                                        e.total_out += c,
                                        r.total += c,
                                        c && (e.adler = r.check = (r.flags ? B : R)(r.check, o, c, a - c)),
                                        c = l,
                                        (r.flags ? d : W(d)) !== r.check) {
                            ...
                            r.hold = d,
                            r.bits = f,
                            (r.wsize || c !== e.avail_out && r.mode < 30 && (r.mode < 27 || 4 !== t)) && D(e, e.output, e.next_out, c - e.avail_out) ? (r.mode = 31,
                            -4) : (u -= e.avail_in,
                            c -= e.avail_out,
                            e.total_in += u,
                            e.total_out += c,
                            r.total += c,
                            r.wrap && c && (e.adler = r.check = (r.flags ? B : R)(r.check, o, c, e.next_out - c)),
                        ...
                        r.inflateSetDictionary = function(e, t) {
                            var r, n = t.length;
                            return !e || !e.state || 0 !== (r = e.state).wrap && 11 !== r.mode ? F : 11 === r.mode && R(1, t, n, 0) !== r.check ? -3 : D(e, t, n, n) ? (r.mode = 31,
                            -4) : (r.havedict = 1,
                            z)
                        }
                        ,
                    ...
                    "zlib/adler32.js": function(e, t, r) {
                        ...
                        t.exports = function(e, t, r, n) {
                            for (var o = 65535 & e | 0, i = e >>> 16 & 65535 | 0, a = 0; 0 !== r; ) {
                                for (r -= a = 2e3 < r ? 2e3 : r; i = i + (o = o + t[n++] | 0) | 0,
                                --a; )
                                    ;
                                o %= 65521,
                                i %= 65521
                    ...
                    "zlib/inffast.js": function(e, t, r) {
                        ...
                        t.exports = function(e, t) {
                            var r, n, o, i, a, s, l = e.state, d = e.next_in, f = e.input, u = d + (e.avail_in - 5), c = e.next_out, h = e.output, m = c - (t - e.avail_out), b = c + (e.avail_out - 257), g = l.dmax, p = l.wsize, w = l.whave, v = l.wnext, y = l.window, k = l.hold, _ = l.bits, x = l.lencode, S = l.distcode, E = (1 << l.lenbits) - 1, U = (1 << l.distbits) - 1;
                            e: do {
                                for (_ < 15 && (k += f[d++] << _,
                                _ += 8,
                                k += f[d++] << _,
                            ...
                            e.avail_out = c < b ? b - c + 257 : 257 - (c - b),
                            l.hold = k,
                            l.bits = _
                        }
                    },
                    "zlib/inftrees.js": function(e, t, r) {
                        ...
                        t.exports = function(e, t, r, n, o, i, a, s) {
                            for (var l, d, f, u, c, h, m, b, g, p = s.bits, w = 0, v = 0, y = 0, k = 0, _ = 0, x = 0, S = 0, E = 0, U = 0, A = 0, C = null, T = 0, P = new O.Buf16(16), L = new O.Buf16(16), R = null, B = 0, w = 0; w <= 15; w++)
                                P[w] = 0;
                            for (v = 0; v < n; v++)
                                P[t[r + v]]++;
                            for (_ = p,
                            ...
                            0 === k)
                                ...
                                for (; ; ) {
                                    ...
                                    0),
                                    l = 1 << (m = w - S),
                                    y = d = 1 << x; o[c + (A >> S) + (d -= l)] = m << 24 | b << 16 | g | 0,
                                    0 !== d; )
                                        ;
                                    for (l = 1 << w - 1; A & l; )
                                        l >>= 1;
        ...
        br: {
            hasUnityMarker: function(e) {
                ...
                if (commentOffset = 1 + r + 2 + 1 + 2 + (o << 3) + 7 >> 3,
        ...
        return e(b[t], {
            ...
            new Promise(function(e, t) {
                try {
                    for (var r in w) {
                        var n, o, i;
                        if (w[r].hasUnityMarker(a))
                            return s && console.log('You can reduce startup time if you configure your web server to add "Content-Encoding: ' + r + '" response header when serving "' + s + '" file.'),
                            (n = w[r]).worker || (o = URL.createObjectURL(new Blob(["this.require = ", n.require.toString(), "; this.decompress = ", n.decompress.toString(), "; this.onmessage = ", function(e) {
                                e = {
                                    id: e.data.id,
    ...
    function y() {
        var t = performance.now()
          , m = (Promise.all([v("frameworkUrl").then(function(e) {
            ...
            return new Promise(function(i, e) {
                ...
                a.onload = function() {
                    if ("undefined" == typeof unityFramework || !unityFramework) {
                        ...
                        for (e in t) {
                            var r, n = t[e];
                            if (b.frameworkUrl.endsWith("." + n[0]))
                                return r = "Unable to parse " + b.frameworkUrl + "!",
                                "file:" == location.protocol ? void d(r + " Loading pre-compressed (brotli or gzip) content via a file:// URL without a web server is not supported by this browser. Please use a local development web server to host compressed Unity content, or use the Unity Build and Run option.", "error") : (r += ' This can happen if build compression was enabled but web server hosting the content was misconfigured to not serve the file with HTTP Response Header "Content-Encoding: ' + n[1] + '" present. Check browser Console and Devtools Network tab to debug.',
                                "br" == n[0] && "http:" == location.protocol && (n = -1 != ["localhost", "127.0.0.1"].indexOf(location.hostname) ? "" : "Migrate your server to use HTTPS.",
            ...
            b.compressedWorkerUrl = b.workerUrl,
            b.workerUrl = t,
            b.deinitializers.push(function() {
        ...
        b.preRun.push(function() {
            ...
            e.then(function(t) {
                ...
                for (r + s > t.length && o("Invalid binary data file header! (pos=" + r + ", headerSize=" + s + ", file length=" + t.length + ")"); r < s; ) {
                    var l = n()
                      , d = n()
                      , f = (l + d > t.length && o("Invalid binary data file size! (offset=" + l + ", size=" + d + ", file length=" + t.length + ")"),
                    n())
                      , u = (r + f > t.length && o("Invalid binary data file path name! (pos=" + r + ", length=" + f + ", file length=" + t.length + ")"),
                    e.decode(t.subarray(r, r + f)));
                    r += f;
                    for (var c = 0, h = u.indexOf("/", c) + 1; 0 < h; c = h,
                    h = u.indexOf("/", c) + 1)
                        b.FS_createPath(u.substring(0, c), u.substring(c, h - 1), !0, !0);
    ...
    return new Promise(function(e, t) {
        var r;
        b.SystemInfo.hasWebGL ? 1 == b.SystemInfo.hasWebGL ? (r = 'Your browser does not support graphics API "WebGL 2" which is required for this content.',
        "Safari" == b.SystemInfo.browser && parseInt(b.SystemInfo.browserVersion) < 15 && (b.SystemInfo.mobile || 1 < navigator.maxTouchPoints ? r += "\nUpgrade to iOS 15 or later." : r += "\nUpgrade to Safari 15 or later."),
        t(r)) : b.SystemInfo.hasWasm ? b.SystemInfo.hasWasm2023 ? (b.startupErrorHandler = t,
        l(0),
